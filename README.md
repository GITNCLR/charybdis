...
This is the QMK Userspace for the Bastard Keyboards keymaps. Customized by Noah for the Charybdis 4x6. Layout features QMK Auto mouse, per layer RGB and the VIA macro fix.
